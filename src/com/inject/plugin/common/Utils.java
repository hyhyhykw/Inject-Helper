package com.inject.plugin.common;

import com.inject.plugin.Settings;
...
public class Utils {
        ...
        file.accept(new XmlRecursiveElementVisitor() {
            ...
            public void visitElement(@NotNull final PsiElement element) {
                ...
                if (element instanceof XmlTag) {
                    ...
                    try {
                        elements.add(new Element(name, value, element.getProject()));
    ...
    public static int getLongClickCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
    ...
    public static int getCheckboxCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
    ...
    public static int getCheckChangeCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
            if (element.isCheckChange) {
                cnt++;
            }
        }
        return cnt;
    ...
    public static int getOnTextChangeCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
    ...
    public static int getBeforeTextChangeCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
    ...
    public static int getAfterTextChangeCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
    ...
    public static int getOnPageChangeCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
    ...
    public static int getOnPageScrollCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
    ...
    public static int getOnPageStateCount(ArrayList<Element> elements) {
        int cnt = 0;
        for (Element element : elements) {
